...
<body>
    ...
    <div class="formtitle"><span>基本信息<b style="font-size:25px;color:red;">【<?php echo ($roleinfo["role_name"]); ?>】</b></span></div>
...
<table  width="100%">
    <?php if(is_array($authinfoA)): foreach($authinfoA as $key=>$v): ?><tr><td width="17%">
            <!--判断当前权限 是否是 当前角色拥有的，如果是，就勾选-->
    ...
    <div style="width:100%;text-align:center;"><input type="submit" class="btn" value="分配权限"></div>
</form>
