...
<html xmlns="http://www.w3.org/1999/xhtml" lang="zh-CN" xmlns:wb="http://open.weibo.com/wb">
    <head>
        ...
        <link href="/Public/Home/layui/css/layui.mobile.css" rel="stylesheet" type="text/css" />
        <script language="JavaScript" src="/Public/Home/layui/layui.js"></script>
    ...
    <script typt="text/javascript">
       function checkname(){
           $('#nameresult').html('<span><img width="15" src="/Public/Home/img/111111.gif" />');
           var mingzi = $('[name=user]').val();
           $.ajax({
               ...
               success:function(msg){
                    if(msg.status===1){
                        $('#nameresult').html("<span style='color:green;'>恭喜,用户名可用</span>");

                    }else{
                        $('#nameresult').html('用户名已存在,请重新填写');
    ...
    <div id="register_box">
        ...
        <div class="input_zone">
            <div class="input_l"><i>用户名：</i></span></div>
            <div class="input_r">
                <input class="user_name input_large_en" onblur="checkname()" type="text" name="user" ajaxurl="/member/ajaxChkReg" datatype="m|e"  id="username" value="" style="color:#ccc;" />
            </div>
            <div class="clear" id="nameresult" style="color:red;"><?php echo ((isset($errorinfo["username"]) && ($errorinfo["username"] !== ""))?($errorinfo["username"]):''); ?></div>
        </div>

        <div class="input_zone">
            <div class="input_l"><i>密码：</i></div>
            <div class="input_r">
                <input class="input_large_en" type="password" name="pwd" id="password" datatype="*6-16" nullmsg="密码不能为空，请输入密码。" errormsg="用户密码长度范围在6~16位之间。" />
            </div>
        ...
        <div class="input_zone">
            ...
            <div class="input_r">
                <input class="input_large_en" type="password" name="pwd2" id="password2" recheck="password" datatype="*" nullmsg="请重新输入一次上面的密码。" errormsg="您两次输入的密码不一致。" />
            </div>
        ...
        <div class="input_zone">
            ...
            <div class="clear" style="color:red;"><?php echo ((isset($errorinfo["user_sex"]) && ($errorinfo["user_sex"] !== ""))?($errorinfo["user_sex"]):''); ?></div>
